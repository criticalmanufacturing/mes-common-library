...
import {
    CustomCodeUtilitiesObjectTranslator,
    ID
} from "../../../../src/tasks/customCodeUtilitiesObjectTranslator/customCodeUtilitiesObjectTranslator.task.util";

describe("CustomCodeUtilitiesObjectTranslator tests", () => {
    let translator: CustomCodeUtilitiesObjectTranslator;

    beforeEach(() => {
        translator = new CustomCodeUtilitiesObjectTranslator();
    });
