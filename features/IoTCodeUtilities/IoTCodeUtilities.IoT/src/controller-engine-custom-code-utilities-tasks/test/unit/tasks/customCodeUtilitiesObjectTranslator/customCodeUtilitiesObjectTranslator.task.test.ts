...
import { CustomUtilitiesUtilObjectTranslator, ID } from "../../../../src/tasks/customCodeUtilitiesObjectTranslator/customCodeUtilitiesObjectTranslator.task.util";
...
describe("CustomCodeUtilitiesObjectTranslator Task tests", () => {
    ...
    it("should register the object translator implementation on the shared task library", async () => {
        ...
        expect(library.implementations[ID]).to.be.an.instanceof(CustomUtilitiesUtilObjectTranslator);
    });
