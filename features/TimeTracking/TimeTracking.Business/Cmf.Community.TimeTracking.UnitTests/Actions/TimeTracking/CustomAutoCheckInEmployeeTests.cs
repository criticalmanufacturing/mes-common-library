...
namespace Cmf.Community.TimeTracking.UnitTests.Actions.TimeTracking
{
    public class CustomAutoCheckInEmployeeTests : ActionBaseTests
    {
        ...
        private readonly Mock<Cmf.Community.TimeTracking.Common.Abstractions.IUtilities> _mockCommonUtilities;
        ...
        public CustomAutoCheckInEmployeeTests()
        {
            ...
            _mockCommonUtilities = AddMockToActionInput<Cmf.Community.TimeTracking.Common.Abstractions.IUtilities>();
        ...
        public void DeeActionCode_EmployeeNotExist_ThrowError()
        {
            ...
            // Act & Assert
            var exception = Xunit.Assert.Throws<CommunityException>(() => _actionUnderTest.DeeActionCode(ActionInput));
