---
name: generate-controller-engine-task-tests
...
Unit tests for `controller-engine-*` tasks follow a strict, consistent pattern across all 12 packages. This skill documents exactly how to write them.
...
- All `@Task.InputProperty` / input fields and their types
