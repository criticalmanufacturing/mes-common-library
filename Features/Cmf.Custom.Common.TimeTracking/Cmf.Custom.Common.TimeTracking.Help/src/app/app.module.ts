...
import { DocsAreaCmfCustomCommonTimetrackingHelpMetadataModule } from 'cmf-docs-area-cmf-custom-common-timetracking-help/metadata';
...
@NgModule({
    ...
    imports: [
        ...
        DocsAreaCmfCustomCommonTimetrackingHelpMetadataModule,
